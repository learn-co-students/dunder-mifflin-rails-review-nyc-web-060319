...
Dog.create(name: "Rex", breed: "Terrier", age: 10)
Dog.create(name: "Goo", breed: "Poodle", age: 5)
Dog.create(name: "Scooby", breed: "Terrier", age: 60)
Dog.create(name: "Raven", breed: "Terrier", age: 4)
